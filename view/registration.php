<main class="main">
    <div class="container">
        ...
        <?php if (empty($_SESSION['isAuth'])) { ?>
            ...
            <form class="form" action="/registration/new" method="post">
                ...
                <a href="/page/rules" class="link link--rules">Правила сайта</a>
                <label class="label" for="checkbox-rule">Прочитал и согласен: <input type="checkbox" name="rule" id="checkbox-rule"></label>
                <div class="form__box">                
